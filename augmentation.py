...
parser.add_argument('--eps', type=int, required=True, default=15, help="The maximum distance between two samples for one to be considered as in the neighborhood of the other.")
parser.add_argument('--min_samples', type=int, required=True, default=10, help="The number of samples in a neighborhood for a point to be considered as a core point.")
parser.add_argument('--radius', type=int, required=True, default=10, help="The radius of region around attention point.")
